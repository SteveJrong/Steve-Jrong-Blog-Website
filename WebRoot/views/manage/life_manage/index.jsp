...
<html>
	<head>
	    <title>Steve Jrong's Blog :: 生活段子管理</title>
	    <!-- Meta Tags -->
	    <meta charset="UTF-8">
		...
		<!-- Define life manage index page CSS -->
	...
	<body>
		...
		<div class="content">
		    <div class="header">
		        <h1 class="page-title">生活段子管理</h1>
		    </div>
		    <ul class="breadcrumb">
		        <li><a href="manage">主页</a> <span class="divider">/</span></li>
		        <li><a class="active">生活段子管理</a></li>
		    </ul>
		    <div class="container-fluid">
		        <div class="row-fluid">
		            <h2>所有生活段子列表</h2>
		            <table id="dg" title="生活段子管理"></table>
		            <!-- Common Footer -->
		...
		<script src="resources/assets/js/manage/page.define/m-life-manage-index-page.js"></script>
	</body>
</html>