...
<html>
	<head>
	    <title>博文信息管理 :: Steve Jrong's Blog</title>
	    <!-- Meta Tags -->
	    <meta charset="UTF-8">
		...
		<!-- Fake Loader CSS -->
		<link rel="stylesheet" href="resources/assets/css/fake-loader.css">
		<!-- Define article manage index page CSS -->
	...
	<body>
		...
		<div class="content">
		    ...
		    <ul class="breadcrumb">
		        ...
		        <li class="active">博文信息管理</li>
		    </ul>
		    <div class="container-fluid">
		        <div class="row-fluid">
		            <h3>博文列表</h3>
		            <table id="dg" title="博文管理"></table>
		            <!-- Common Footer -->
		...
		<script src="resources/assets/js/manage/page.define/m-article-manage-index-page.js"></script>
	</body>
</html>