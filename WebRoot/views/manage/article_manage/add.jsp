...
<html>
	<head>
	    <title>发布博文信息 :: Steve Jrong's Blog</title>
	    <!-- Meta Tags -->
	    <meta charset="UTF-8">
	...
	<body>
		...
		<div class="content">
		    ...
		    <ul class="breadcrumb">
		        ...
		        <li><a href="manage">博文信息管理</a>  <span class="divider">/</span></li><li class="active">发布博文信息</li>
		    </ul>
		    <div class="container-fluid">
		        <div class="row-fluid">
		            <h2>发布博文信息</h2>
			            ...
			            <div class="basic">
			            	<ul class="basic-info">
			            		<li>博文名称：</li><li><input name="aname" type="text" placeholder="请键入博文名称" maxlength="50" /></li>
			            		<li>博文类型：</li>
			            			<li>
			            		...
			            		<li>博文关键字：</li><li><input name="atag" type="text" placeholder="请键入博文关键字" maxlength="10" /></li>
			            		<li>置顶：<input type="checkbox" name="atop" /></li>
			            		<li>简略介绍：</li><li><textarea name="abrief" style="width: 95%" rows="5" placeholder="请在此以纯文本的形式简略的介绍博文信息" maxlength="500"></textarea></li>
			            		<li>附件资源上传（选中后自动上传）：</li>
			            		<li>
			            			<input type="file" name="uploadFiles" id="uploadify" />
									<!-- <p><a href="javascript:$('#uploadify').uploadify('upload')" class="btn btn-primary">开始上传</a></p> -->
			            		</li>
			            	</ul>
			            </div>
		            	<textarea class="ckeditor" id="content" name="content" rows="10"></textarea>
		            	<input type="submit" value="发布博文" class="btn btn-primary" />
		            </form>
					<!-- Common Footer -->
