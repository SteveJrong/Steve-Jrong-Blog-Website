...
<html>
	<head>
	    <title>Steve Jrong's Blog :: 用户信息管理</title>
	    <!-- Meta Tags -->
	    <meta charset="UTF-8">
		...
		<!-- Define user manage index page CSS -->
	...
	<body>
		...
		<div class="content">
		    ...
		    <div class="container-fluid">
		        <div class="row-fluid">
		            <h2>所有用户列表</h2>
		            <table id="dg" title="用户信息管理"></table>
		            <!-- Common Footer -->
		...
		<script src="resources/assets/js/manage/page.define/m-user-manage-index-page.js"></script>
	</body>
</html>