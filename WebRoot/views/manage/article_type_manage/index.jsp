...
<html>
	<head>
	    <title>博文类型管理 :: Steve Jrong's Blog</title>
	    <!-- Meta Tags -->
	    <meta charset="UTF-8">
		...
		<!-- Define article type manage index page CSS -->
	...
	<body>
		...
		<div class="content">
		    <div class="header">
		        <h1 class="page-title">博文类型管理</h1>
		    </div>
		    <ul class="breadcrumb">
		        <li><a href="manage">主页</a> <span class="divider">/</span></li>
		        <li><a class="active">博文类型管理</a></li>
		    </ul>
		    <div class="container-fluid">
		        <div class="row-fluid">
		            <h2>博文类型列表</h2>
		            <table id="dg" title="博文类型管理"></table>
		            <!-- Common Footer -->
		...
		<script src="resources/assets/js/manage/page.define/m-article-type-manage-index-page.js"></script>
	</body>
</html>