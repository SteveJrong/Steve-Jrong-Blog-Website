/**
 * File Name:Steve Jrong's Blog - MySQL DataBase SQL File
 * Create Date:2016年10月28日 15:31:57
 * Modify Date:2016年10月28日 15:31:57
 * Version:1.1
*/
  
-- 导出 sjblogdb 的数据库结构
DROP DATABASE IF EXISTS `sjblogdb`;
CREATE DATABASE IF NOT EXISTS `sjblogdb`
USE `sjblogdb`;

-- 导出  表 sjblogdb.sj_articles 结构
DROP TABLE IF EXISTS `sj_articles`;
CREATE TABLE IF NOT EXISTS `sj_articles` (
...
-- 导出  表 sjblogdb.sj_articletypes 结构
DROP TABLE IF EXISTS `sj_articletypes`;
CREATE TABLE IF NOT EXISTS `sj_articletypes` (
...
-- 导出  表 sjblogdb.sj_file_attachments 结构
DROP TABLE IF EXISTS `sj_file_attachments`;
CREATE TABLE IF NOT EXISTS `sj_file_attachments` (
...
-- 导出  表 sjblogdb.sj_guestsdatehistorydetail 结构
DROP TABLE IF EXISTS `sj_guestsdatehistorydetail`;
CREATE TABLE IF NOT EXISTS `sj_guestsdatehistorydetail` (
...
-- 导出  表 sjblogdb.sj_guestshistory 结构
DROP TABLE IF EXISTS `sj_guestshistory`;
CREATE TABLE IF NOT EXISTS `sj_guestshistory` (
...
-- 导出  表 sjblogdb.sj_leavemessages 结构
DROP TABLE IF EXISTS `sj_leavemessages`;
CREATE TABLE IF NOT EXISTS `sj_leavemessages` (
  ...
  `M_IPADDRESS` varchar(50) DEFAULT NULL,
  `M_DEVICEINFO` varchar(100) DEFAULT NULL,
  `M_SYSTEMINFO` varchar(100) DEFAULT NULL,
  `M_PRAISE_COUNT` bigint(20) DEFAULT '0' COMMENT '点赞数',
  PRIMARY KEY (`M_ID`),
  KEY `M_U_ID` (`M_U_ID`),
...
-- 导出  表 sjblogdb.sj_life 结构
DROP TABLE IF EXISTS `sj_life`;
CREATE TABLE IF NOT EXISTS `sj_life` (
