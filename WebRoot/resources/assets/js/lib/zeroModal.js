...
(function(obj) {
    ...
    var defaultOpt = {
        ...
        okEagerClose: false, //点击“ok”按钮后立即关闭窗口
     ...
     * @return {[type]}   [description]
     */
    zeroModal.definesuccess = function(img,content) {
        var params = {
            iconDisplay: "<div style='width:55px; height:55px; margin:0px auto; overflow:hidden;'><img src='"+img+"' width='35px' height='35px' style='margin-left:20px;'/></div>"
        };
