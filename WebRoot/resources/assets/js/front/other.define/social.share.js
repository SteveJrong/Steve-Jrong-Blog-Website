...
(function($, window, document, undefined) {
    ...
    function init(target, options) {
		...
		//初始化各个组件
        var $msb_main = "<a class='msb_main'><img title='分享' src='resources/assets/img/share_core_square.jpg'></a>";
	...
	$("body").append("<div id='socialShare' style='position:fixed;  bottom: 4em; right: 0.5em; float:right;'></div>");
