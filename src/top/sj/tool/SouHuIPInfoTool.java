/*
 * Project Name: SJBlog
 * Class Name: SouHuIPInfoTool.java
 * 
 ...
 * Modify Date: 2016年11月25日 17:23:01
 * Modify Remark: 
 * 
 * @author SteveJrong
 * @version 1.0
 */
public class SouHuIPInfoTool {
	...
	public static String getPublishedProvinceAndCity() {
		String info = new SouHuIPInfoTool().sendGet(
	 ...
	 */
	@SuppressWarnings("static-access")
	public static String getPublishedIPAddress() {
		String info = new SouHuIPInfoTool().sendGet(
	...
	public static void main(String[] args) {
		...
		System.out.println(getPublishedIPAddress());
	}
}
